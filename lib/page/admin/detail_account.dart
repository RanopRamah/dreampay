              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (ctx) => const MakeAccountPage()),(route) => false);
                      });
                    },
                    child: Container(
                      width: 52,
                      ...
                      child: Center(
                        child: Image.asset('assets/image/cross.png', width: 19, height: 19),
                      ),
                    ),
                  ),
                ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Image.asset('assets/image/edit_account.png', width: 19.5, height: 19.99),
                            ),
                          ),
                        ],
                      ),
